...
class _SettingsScreenState extends State<SettingsScreen> {
            ...
            onPressed: () async {
              ...
              try {
                ...
                if (response.statusCode == 200) {
                  ...
                  await _saveHeightWeightUpdateDate();
                } else {
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextField(controller: confirmNewPasswordController, obscureText: true, decoration: const InputDecoration(labelText: "Confirm New Password")),
            ],
          ),
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                ...
                if (response.statusCode == 200) {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("User info updated successfully")));
                } else {
  ...
  void _editChildInfo(BuildContext context) {
    ...
    if (selectedBaby.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Selected baby not found")));
      return;
    }
    ...
    void _submitUpdate() async {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          await authService.fetchBabies();
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Child info updated successfully")));
          setState(() {});
        } else {
          final msg = jsonDecode(response.body)['message'];
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Failed: $msg")));

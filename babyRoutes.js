...
router.post('/babies/appointments/:babyId', isAuth, babyController.createAppointment);
router.delete('/appointments/:id', isAuth, babyController.deleteAppointment);
router.put('/appointments/:id', isAuth, babyController.updateAppointment);
...
router.get('/analysis/:babyId', isAuth, babyController.getBabyAnalysis);
//router.get('/vaccine', isAuth, babyController.getUserVaccines);
router.post('/feeding/:babyId', isAuth, babyController.addFeeding);
...
router.get('/notifications', isAuth, babyController.getBabyNotifications);
...
router.get('/reports/growth/:babyId', isAuth,babyController.getGrowthData);
router.get('/reports/feeding/:babyId', isAuth,babyController.getFeedingStats);
router.get('/reports/sleep/:babyId', isAuth, babyController.getSleepStats);
...
router.post('/sleep/:babyId', isAuth, babyController.startSleep);
router.patch('/sleep/end/:sleepId', isAuth, babyController.endSleep);
